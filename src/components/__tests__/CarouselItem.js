...
test('Carousel have class carousel-item', () => {
    const { container } = render(<CarouselItem className="carousel-item"></CarouselItem>)

    expect(container.firstChild).toHaveClass('carousel-item')
})

test('Carousel have class active carousel-item', () => {
    const { container } = render(<CarouselItem className="carousel-item " active="active"></CarouselItem>)

    expect(container.firstChild).toHaveClass('carousel-item active')
})

test('Carousel have class justify-content-center', () => {
    const { container } = render(<CarouselItem className="justify-content-center" active="active"></CarouselItem>)
